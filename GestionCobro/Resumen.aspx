...
<PagerStyle CssClass=" pagination"></PagerStyle>
    ...
    <div  id="divPopUp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="lblHidden" PopupControlID="Reasignar" BackgroundCssClass="modalBackground"></ajaxToolkit:ModalPopupExtender>
    <div  id="Reasignar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">Documentos por Reasignar Pendientes</h4>
                      </div>
                      <div class="modal-body">

                        Hay documentos por reasignar pendientes, desea re-asignarlos?<br />
                          Ruta: <asp:Label Font-Bold="true" runat="server" ID="lblRutaCerrar"></asp:Label><br />
                          Total Documentos: <asp:Label Font-Bold="true" runat="server" ID="lblDocumentosporreasignar"></asp:Label><br />

                      </div>
                      <div class="modal-footer">
                          <asp:Button id="btnCancelReasignar" OnClick="btnCancelReasignar_Click" CssClass="btn btn-default" runat="server" text="Cancel" />
                          <asp:Button id="btnOKReasignar" OnClick="btnOKReasignar_Click" runat="server" text="Ok" CssClass="btn btn-success"/>
                      </div>
                    </div>
                  </div>
                </div>
