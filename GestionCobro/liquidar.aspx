        ...
        <table cellpadding="0" cellspacing="0">
                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <td>
                                Documento #:<asp:Label runat="server" ID="lblTipo"/> - <asp:Label runat="server" ID="lblFact"/><br>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="information">
                ...
                <td>
                    ...
                    <asp:CheckBox runat="server" ID="chkVaDeNuevo" Text="Enviar a Ruta" Checked="false" Font-Bold="true" Visible="false" />
                </td>
            </tr>
