<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="GestionCobro.Inicio" %>
  ...
  .button-71 {
	...
	<script>
        document.addEventListener("DOMContentLoaded", function () {
            WebForm_FireDefaultButton(event, 'login');
        });
</script>
</head>
<body>
<!-- partial:index.partial.html -->
	...
	<div id="usuario" runat="server" class="inputGroup inputGroup1">
		<label for="loginEmail" id="loginEmailLabel">Usuario</label>
	<asp:TextBox ID="loginEmail" autofocus="true" runat="server" MaxLength="254"></asp:TextBox>
		<p class="helper helper1">Usuario</p>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="loginPassword" id="loginPasswordLabel">Clave</label>
	...
	<div class="inputGroup inputGroup3">
		<asp:Button runat="server" CssClass=" button-71"  OnClick="login_Click" Text="Iniciar" id="login"></asp:Button>
	</div>	
			</asp:Panel>
</form>
	<!-- Footer con leyenda de copyright -->
<footer class="bg-dark text-white py-3" style="position:fixed;margin-bottom:0;bottom:0px;width:100%">
    <div class="container text-center">
        <p>&copy; <span id="year"></span> Elaborado por Luis Miguel Bolaños Mejias v. 2023.09.13</p>
    </div>
</footer>

<!-- Agrega el script para obtener el año actual -->
<script>
