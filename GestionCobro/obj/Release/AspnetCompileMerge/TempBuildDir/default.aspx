...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
 ...
 <div id="Asignar" class="col-lg-3 col-md-3 col-sm-12 col-xs-12" runat="server" visible="true">
          ...
          <!--/.col-->
            ...
            <a href="controlfacturas.aspx">
 <div id="Control" class="col-lg-3 col-md-3 col-sm-12 col-xs-12" runat="server" visible="true">
 ...
 <div id="Div1" class="col-lg-3 col-md-3 col-sm-12 col-xs-12" runat="server" visible="true">
            <div class="info-box twitter-bg">
              <i class="fa fa-bell"></i>
              <div class="count" style="font-size:25px">Devoluciones</div>
              <div class="title">por Ruta</div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
